...
ALTER TABLE ptvselected ADD COLUMN geom geometry(Point, 3067);

UPDATE ptvselecteD SET geom = ST_SetSRID(ST_MakePoint("longitude", "latitude"), 3067);

ALTER TABLE ptvselected ADD COLUMN datalahde varchar;

UPDATE ptvselected SET datalahde = 'PTV';
